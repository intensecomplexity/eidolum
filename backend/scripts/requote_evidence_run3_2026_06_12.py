"""Quote-representativeness re-quote RUN 3 (2026-06-12 transient-retry) — EVIDENCE ONLY.
...
RESULTS = os.path.join(HERE, 'requote_run3_results_2026_06_12.json')
MARKER = '[requote_run3_2026_06_12'
        ...
        cur.execute(
            """UPDATE predictions
               SET source_verbatim_quote = %s,
                   ...
                   source_timestamp_method = 'requote_run3_2026_06_12',
                   evaluation_summary = COALESCE(evaluation_summary,'')
                       || ' [requote_run3_2026_06_12 evidence-only: verbatim quote + timestamp replaced; outcome/direction/return UNCHANGED]'
               WHERE id = %s""",
