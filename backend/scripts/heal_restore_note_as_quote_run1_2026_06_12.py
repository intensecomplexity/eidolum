"""Heal pass run 1 (2026-06-12) — restore VERIFIED rows of the
...
Companion artifact (same directory, committed together):
    heal_run1_results_2026_06_12.json
...
skip rows already noted. Transactional. Run manually against prod:
    DATABASE_PUBLIC_URL=... python3 backend/scripts/heal_restore_note_as_quote_run1_2026_06_12.py
...
ARTIFACT = os.path.join(HERE, 'heal_run1_results_2026_06_12.json')
