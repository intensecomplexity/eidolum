"""Quote-representativeness re-quote RUN 2 (2026-06-12 tail) — EVIDENCE ONLY.
...
RESULTS = os.path.join(HERE, 'requote_run2_results_2026_06_12.json')
MARKER = '[requote_run2_2026_06_12'
        ...
        cur.execute(
            """UPDATE predictions
               SET source_verbatim_quote = %s,
                   ...
                   source_timestamp_method = 'requote_run2_2026_06_12',
                   evaluation_summary = COALESCE(evaluation_summary,'')
                       || ' [requote_run2_2026_06_12 evidence-only: verbatim quote + timestamp replaced; outcome/direction/return UNCHANGED]'
               WHERE id = %s""",
