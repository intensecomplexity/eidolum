...
export default function ForecasterProfile() {
  ...
  const commentCounts = useCommentCounts(
    [...(data?.predictions || []), ...extraPreds].map(p => p.id || p.prediction_id),
    'analyst'
  );
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        {/* Dormancy banner hidden — same reason as the leaderboard DORMANT
            badge: many "dormant" forecasters publish constantly but our
            classifier can't extract predictions from their content style. */}
